...
namespace ProceduralToolkit.Examples
{
    ...
    public class Boids : MonoBehaviour
    {
        ...
        private void Generate()
        {
            ...
            {
				boid.biodGo = (GameObject) Instantiate(boidPrefab);
...
//                SetBoidVertices(boid, i);
				...
				boid.biodGo.transform.position = boid.position;
				boid.biodGo.transform.forward = boid.velocity;
